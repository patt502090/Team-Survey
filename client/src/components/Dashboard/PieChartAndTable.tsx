    ...
    <div className="p-4 md:p-auto bg-gray-50">
      <div className="mx-auto max-w-full bg-white rounded-lg shadow-lg p-4 md:p-6">
        ...
        <div className="flex flex-col md:flex-row items-start justify-between gap-4 md:gap-8">
          {/* Pie Chart Section */}
          <div className="w-full md:w-1/2" role="img" aria-label="Customer distribution pie chart">
          ...
          <div className="w-full md:w-1/2 mt-6 md:mt-0">
            <div className="overflow-x-auto">
              <table className="w-full text-xs md:text-sm text-left text-gray-500" role="table">
                <thead className="text-xs text-gray-700 uppercase bg-gray-100">
                  <tr>
                    <th scope="col" className="px-3 md:px-6 py-2 md:py-3 rounded-tl-lg">Category</th>
                    <th scope="col" className="px-3 md:px-6 py-2 md:py-3">Distribution</th>
                    <th scope="col" className="px-3 md:px-6 py-2 md:py-3">Count</th>
                    <th scope="col" className="px-3 md:px-6 py-2 md:py-3 rounded-tr-lg">Revenue</th>
                  </tr>
                </thead>
                <tbody>
