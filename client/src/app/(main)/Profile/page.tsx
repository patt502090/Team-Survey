...
export default function Profile() {
    return (
        ...
        <main className="flex gap-4 flex-wrap flex-col self-center contanier mx-auto p-4 mt-2 md:hidden">
            <div className="bg-white rounded-lg p-4 shadow-lg border-4 border-gray-300">
                <div className="flex w-full h-full relative rounded-full">
                    <img 
            ...
            <div className="bg-white flex flex-col p-4 rounded-lg gap-2 border-4 border-gray-300">
            ...
            <button className="bg-red-500 rounded-md text-white font-bold p-2 text-xl hover:bg-red-400 shadow-lg">logout</button>
        </main>
