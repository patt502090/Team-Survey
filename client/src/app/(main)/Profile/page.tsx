        ...
        <div className="flex flex-col min-h-screen bg-gradient-to-r from-blue-50 to-blue-100">
            ...
            <main className="flex flex-col items-center container mx-auto p-4 mt-4">
                ...
                <div className="flex gap-8">
                  <button onClick={Logout} className="mt-6 bg-blue-500 rounded-md text-white font-bold py-2 px-4 text-xl hover:bg-red-400 transition-shadow duration-200 shadow-md hover:shadow-lg">
                      Edit
                  </button>
